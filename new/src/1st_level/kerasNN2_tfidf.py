...
make_submission(pred, ids, encoder, fname=path+'kerasNN2_tfidf.csv')
print(log_loss(labels,submissionTr.values,eps=1e-15, normalize=True))
submissionTr.to_csv(path+"kerasNN2_tfidf_retrain.csv",index_label='id')

# nfold 3, bagging  5: 0.49331667 + 0.0062007
# nfold 3, bagging 10: 0.48966445 + 0.0067123
# nfold 5, bagging  5: 0.4838044 + 0.013019
# nfold 5, bagging 10: 0.4807044 + 0.014114
# nfold 8, bagging 10: 0.4808655 + 0.0099286
