...
make_submission(pred, ids, encoder, fname=path+'kerasNN3_tfidf.csv')
print(log_loss(labels,submissionTr.values,eps=1e-15, normalize=True))
submissionTr.to_csv(path+"kerasNN3_tfidf_retrain.csv",index_label='id')

# nfold 2: 0.535282 + 0.00488305
# nfold 3: 0.516283 + 0.0080505

# nfold 3, bagging 5: 0.497290 + 0.0065782
# nfold 5, bagging 5: 0.4872675 + 0.01446836
# nfold 5, bagging 10: 0.4853455 + 0.0133368
